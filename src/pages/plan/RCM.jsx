...
const BASE_CONTROLS = [
  {control_id:'LA-01',domain:'LA',control_title:'User provisioning',risk:'Unauthorized access granted',risk_rating:'High',control_type:'Preventive',frequency:'Per event',assertion:['Authorization'],evidence_req:'Access request + approver sign-off',pcaob_ref:'AS 2201 Para .26'},
  {control_id:'LA-02',domain:'LA',control_title:'Periodic access review',risk:'Inappropriate access retained',risk_rating:'High',control_type:'Detective',frequency:'quarterly',assertion:['Existence'],evidence_req:'Certified access review report + IPE validation',pcaob_ref:'AS 2201 Para .26'},
  {control_id:'LA-03',domain:'LA',control_title:'User deprovisioning',risk:'Terminated users retain access',risk_rating:'High',control_type:'Preventive',frequency:'Per event',assertion:['Authorization'],evidence_req:'HR termination list vs system user list — within SLA',pcaob_ref:'AS 2201 Para .26'},
  {control_id:'LA-04',domain:'LA',control_title:'Privileged access controls',risk:'Unrestricted system access',risk_rating:'High',control_type:'Preventive',frequency:'quarterly',assertion:['Authorization'],evidence_req:'Privileged account list + justification + MFA config',pcaob_ref:'AS 2201 Para .26'},
  {control_id:'LA-05',domain:'LA',control_title:'SoD enforcement',risk:'Single user can execute and conceal fraud',risk_rating:'High',control_type:'Preventive',frequency:'quarterly',assertion:['Authorization'],evidence_req:'SoD conflict matrix + mitigation evidence',pcaob_ref:'AS 2201 Para .26'},
  {control_id:'CM-01',domain:'CM',control_title:'Change authorization',risk:'Unauthorized changes to production',risk_rating:'High',control_type:'Preventive',frequency:'Per event',assertion:['Authorization'],evidence_req:'Change ticket with pre-deployment approval timestamp',pcaob_ref:'AS 2201 Para .28'},
  {control_id:'CM-02',domain:'CM',control_title:'UAT sign-off',risk:'Untested changes affect financial data',risk_rating:'High',control_type:'Preventive',frequency:'Per event',assertion:['Accuracy'],evidence_req:'Business user UAT sign-off dated before go-live',pcaob_ref:'AS 2201 Para .28'},
  {control_id:'CM-03',domain:'CM',control_title:'Emergency change controls',risk:'CM bypass via emergency classification',risk_rating:'High',control_type:'Detective',frequency:'monthly',assertion:['Authorization'],evidence_req:'Emergency change rate report + retrospective approvals',pcaob_ref:'AS 2201 Para .28'},
  {control_id:'CM-04',domain:'CM',control_title:'Dev/prod separation',risk:'Developer deploys unauthorized code',risk_rating:'High',control_type:'Preventive',frequency:'quarterly',assertion:['Authorization'],evidence_req:'Developer list vs prod access list — zero overlap',pcaob_ref:'AS 2201 Para .28'},
  {control_id:'CO-01',domain:'CO',control_title:'Batch job monitoring',risk:'Failed jobs produce incomplete financial data',risk_rating:'High',control_type:'Detective',frequency:'daily',assertion:['Completeness'],evidence_req:'Job execution logs + incident tickets for failures',pcaob_ref:'AS 2201 Para .27'},
  {control_id:'CO-02',domain:'CO',control_title:'Backup controls',risk:'Data loss / inability to recover',risk_rating:'High',control_type:'Detective',frequency:'daily',assertion:['Completeness'],evidence_req:'Backup job logs + annual restore test results',pcaob_ref:'AS 2201 Para .27'},
  {control_id:'CO-03',domain:'CO',control_title:'DR plan testing',risk:'Business continuity failure',risk_rating:'Medium',control_type:'Detective',frequency:'annual',assertion:['Completeness'],evidence_req:'DR test results with RTO/RPO validation + sign-off',pcaob_ref:'AS 2201 Para .27'},
  {control_id:'PD-01',domain:'PD',control_title:'SDLC phase gate approvals',risk:'Inadequate system design deployed',risk_rating:'High',control_type:'Preventive',frequency:'Per project',assertion:['Authorization'],evidence_req:'Phase gate sign-offs with named approver and date',pcaob_ref:'AS 2201 Para .29'},
  {control_id:'PD-02',domain:'PD',control_title:'Data migration reconciliation',risk:'Incomplete/inaccurate data migrated',risk_rating:'High',control_type:'Detective',frequency:'Per project',assertion:['Completeness','Accuracy'],evidence_req:'Pre/post count reconciliation + balance agreement + business sign-off',pcaob_ref:'AS 2201 Para .29'},
  {control_id:'JE-01',domain:'JE',control_title:'JE population IPE validation',risk:'Incomplete JE population tested',risk_rating:'High',control_type:'Detective',frequency:'Per period',assertion:['Completeness'],evidence_req:'JE extract reconciled to trial balance + parameter doc',pcaob_ref:'AS 2110.61'},
  {control_id:'JE-02',domain:'JE',control_title:'After-hours JE review',risk:'Fraudulent JEs posted outside business hours',risk_rating:'High',control_type:'Detective',frequency:'Per period',assertion:['Authorization'],evidence_req:'After-hours JE sample with supporting docs + approver ≠ preparer',pcaob_ref:'AS 2110.61'},
]

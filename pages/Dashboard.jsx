  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mt-2">
        {[
          {to:'/executive', label:'Executive summary', desc:'ICFR conclusion, disclosure obligations, board pack', color:'bg-purple-50 dark:bg-purple-900/20 border-purple-200 dark:border-purple-800'},
          {to:'/inspection-readiness', label:'Inspection readiness', desc:'Scan for what a PCAOB inspector would challenge', color:'bg-blue-50 dark:bg-blue-900/20 border-blue-200 dark:border-blue-800'},

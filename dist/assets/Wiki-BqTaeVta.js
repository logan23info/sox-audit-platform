import{r as e}from"./rolldown-runtime-hePW80VL.js";import{r as t,t as n}from"./jsx-runtime-39qeawTm.js";import{E as r,S as i,x as a}from"./index-mPFYXDQW.js";import{t as o}from"./PageHeader-ipW0SCNH.js";var s=e(t(),1),c=n(),l=[{title:`1. Getting started`,content:`**What is this platform?**
...
Go to Programmes → New engagement. Enter the entity name, fiscal year, and sector. Each engagement is a self-contained workspace — all data (scope, controls, findings, reports) is isolated per engagement. Select the engagement to activate it before using any other page.`},{title:`2. Phase 1 — Plan the audit`,content:`**Step 1: Scoping worksheet**
...
Navigate to Schedule. Click "Seed milestones" to load 16 standard milestones across Planning, Fieldwork, Review, Reporting, and Follow-up phases. Set due dates and assign owners.`},{title:`3. Phase 2 — Execute testing`,content:`**Step 1: IPE validation (mandatory first)**
...
**Step 6: SoD matrix**
Navigate to Execute → SoD Matrix. Document all segregation of duties conflicts. For each conflict, add compensating controls and test their effectiveness.`},{title:`4. Phase 3 — Manage & report`,content:`**Remediation tracker**
...
**Audit reports**
Navigate to Manage → Reports. Create the audit report, auto-fill the findings section from the finding register, and export as XLSX or PDF. Do not issue a clean opinion if any MW remains open.`},{title:`5. AI features`,content:`**AI finding assessment**
...
**Key principle:** The platform uses temperature 0.1 for all AI calls, minimising hallucination. If evidence is insufficient or ambiguous, the AI returns INSUFFICIENT_EVIDENCE rather than guessing. Human review is always required.`},{title:`6. Analytics & reporting`,content:`**Current engagement analytics**
...
**Client portal**
Navigate to Client Portal. Generate a read-only token link for management or the audit committee. The portal shows signed-off findings, deficiency log, and remediation status. Revoke links when the engagement closes.`},{title:`7. Team management`,content:`**Roles**
...
**Removing members**
Only the Lead can remove members. Removal takes effect immediately — the member loses access to all engagement data.`},{title:`8. Reference pages`,content:`**Framework crosswalk**
...
**Interview prep**
12 flashcard questions covering key SOX ITGC concepts — useful for team onboarding or pre-engagement refreshers.`}];function u(){let[e,t]=(0,s.useState)(null);return(0,c.jsxs)(`div`,{className:`p-6 max-w-4xl mx-auto`,children:[(0,c.jsx)(o,{eyebrow:(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)(r,{size:12}),`Reference · Wiki`]}),title:`SOX audit platform — user guide`,subtitle:`End-to-end guide for running a SOX ITGC engagement. Aligned to PCAOB AS 2201, AS 2315, AS 2110, and QC 1000.`}),(0,c.jsx)(`div`,{className:`space-y-2`,children:l.map((n,r)=>(0,c.jsxs)(`div`,{className:`card p-0 overflow-hidden`,children:[(0,c.jsxs)(`button`,{onClick:()=>t(e===r?null:r),className:`w-full flex items-center justify-between px-5 py-4 text-left hover:bg-gray-50 dark:hover:bg-dark-surface-3 transition-colors`,children:[(0,c.jsx)(`span`,{className:`font-semibold text-gray-900 dark:text-white`,children:n.title}),e===r?(0,c.jsx)(i,{size:16,className:`text-gray-400`}):(0,c.jsx)(a,{size:16,className:`text-gray-400`})]}),e===r&&(0,c.jsx)(`div`,{className:`px-5 pb-5 border-t border-gray-100 dark:border-gray-800`,children:n.content.split(`

`).map((e,t)=>{if(e.startsWith(`**`)&&e.includes(`**
`)){let[n,...r]=e.split(`
`);return(0,c.jsxs)(`div`,{className:`mt-4`,children:[(0,c.jsx)(`h4`,{className:`font-semibold text-gray-900 dark:text-white mb-1`,children:n.replace(/\*\*/g,``)}),r.join(`
`).split(`
`).filter(Boolean).map((e,t)=>e.startsWith(`- `)?(0,c.jsx)(`li`,{className:`text-sm text-gray-600 dark:text-gray-400 ml-4 list-disc`,children:e.slice(2)},t):(0,c.jsx)(`p`,{className:`text-sm text-gray-600 dark:text-gray-400 leading-relaxed`,children:e},t))]},t)}return(0,c.jsx)(`p`,{className:`text-sm text-gray-600 dark:text-gray-400 leading-relaxed mt-3`,children:e},t)})})]},r))})]})}export{u as default};